...
model.fit(X, Y, batch_size = 64, epochs = 100, verbose = 2, callbacks = [early_stopping, reduce_lr, csv_logger, checkpoint], validation_split = 0.1, shuffle = True, sample_weight = W)
"""
## Test:
